# Bun NestJS API Template

A modern [NestJS](https://nestjs.com/) REST API template powered by [Bun.js](https://bun.sh/) runtime and [Biome.js](https://biomejs.dev/) for linting and formatting.
...
- 🌐 **REST API** - Express-based HTTP server for RESTful endpoints
